    ...
    return (
        <div>
            <div className="d-flex p-2" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '300px' }}>
                <h2 tag='div' className='display-1 pb-3 mb-3 border-bottom' style={{ fontWeight: "bold" }}>ADD DELIVERY ADDRESS DETAIL</h2>
            </div>
                ...
                <div className="col" style={{ borderRadius: '33px', height: '1100px' }}>
                    <form style={{ paddingTop: "70px" }}>
                        <div className="form-group row">
                            <label htmlFor="inputSubject" className="col-sm-2 col-form-label col-form-label-lg" style={{ fontSize: "170%", fontWeight: "bold", height: '100px' }}>Full Name: <label style={{ color: 'red' }}>*</label></label>
                        ...
                        <div className="form-group row">
                            <label htmlFor="inputSubject" className="col-sm-2 col-form-label col-form-label-lg" style={{ fontSize: "170%", fontWeight: "bold", height: '100px' }}>Address Line 1 (No): <label style={{ color: 'red' }}>*</label></label>
                            <div className="col-sm-10">
                        ...
                        <div className="form-group row">
                            <label htmlFor="inputSubject" className="col-sm-2 col-form-label col-form-label-lg" style={{ fontSize: "170%", fontWeight: "bold", height: '100px' }}>Address Line 2 (Lane): <label style={{ color: 'red' }}>*</label></label>
                            <div className="col-sm-10">
                        ...
                        <div className="form-group row">
                            <label htmlFor="inputSubject" className="col-sm-2 col-form-label col-form-label-lg" style={{ fontSize: "170%", fontWeight: "bold", height: '100px' }}>Address Line 3 (City): <label style={{ color: 'red' }}>*</label></label>
                            <div className="col-sm-10">
                        ...
                        <div className="form-group row">
                            <label htmlFor="inputSubject" className="col-sm-2 col-form-label col-form-label-lg" style={{ fontSize: "170%", fontWeight: "bold", height: '100px' }}>phoneNumber Number: <label style={{ color: 'red' }}>*</label></label>
                            <div className="col-sm-10">
                        ...
                        <div className="form-group row">
                            <label htmlFor="inputSubject" className="col-sm-2 col-form-label col-form-label-lg" style={{ fontSize: "170%", fontWeight: "bold", height: '100px' }}>Email: <label style={{ color: 'red' }}>*</label></label>
                            <div className="col-sm-10">
                        ...
                        <div className="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
                            ...
                            <button type="reset" className="btn btn-outline-primary" style={{ float: 'center', padding: '12px 68px', marginBottom: '30px', fontWeight: 'bold', fontSize: "130%" }} ><XCircle /> Clear</button>
