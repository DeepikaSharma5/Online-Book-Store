                        ...
                        <div className="row">
                            <div>
                                <div className="d-flex p-2" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '200px', position: 'relative', marginBottom: '-50px', marginTop: '20px' }}>
                                    <h4 tag='div' className='display-1 pb-3 mb-3 border-bottom' style={{ fontWeight: "bold", fontSize: '180%' }}>DELIVERED</h4>
                                </div>
                            ...
                            <div>
                                <div className="d-flex p-2" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '200px', position: 'relative', marginBottom: '-50px', marginTop: '20px' }}>
                                    <h4 tag='div' className='display-1 pb-3 mb-3 border-bottom' style={{ fontWeight: "bold", fontSize: '180%' }}>PROCESSING</h4>
                                </div>
                                <table className="table table-bordered" style={{ textAlign: 'center', maxWidth: '80%', margin: 'auto', padding: '10px' }}>
                                    <thead className="thead-light" >
                                        <tr>
                            ...
                            <div>
                                <div className="d-flex p-2" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '200px', position: 'relative', marginBottom: '-50px', marginTop: '20px' }}>
                                    <h4 tag='div' className='display-1 pb-3 mb-3 border-bottom' style={{ fontWeight: "bold", fontSize: '180%' }}>SHIPPED</h4>
                                </div>
                                <table className="table table-bordered" style={{ textAlign: 'center', maxWidth: '80%', margin: 'auto', padding: '10px' }}>
                                    <thead className="thead-light" >
                                        <tr>
                            ...
                            <div>
                                <div className="d-flex p-2" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '200px', position: 'relative', marginBottom: '-50px', marginTop: '20px' }}>
                                    <h4 tag='div' className='display-1 pb-3 mb-3 border-bottom' style={{ fontWeight: "bold", fontSize: '180%' }}>PENDING</h4>
                                </div>
                                <table className="table table-bordered" style={{ textAlign: 'center', maxWidth: '80%', margin: 'auto', padding: '10px' }}>
                                    <thead className="thead-light" >
                                        <tr>
