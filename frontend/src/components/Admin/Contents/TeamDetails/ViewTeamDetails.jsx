        ...
        <div>
            <div>
                <div className="d-flex p-2" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '300px' }}>
                    <h1 tag='div' className='display-1 pb-3 mb-3 border-bottom'>VIEW TEAM DETAILS</h1>
                </div>
            </div>
            {/* <Navigation/> */}
                        ...
                        <div class="col-sm-3 mt-3">
                            <div class="card">
                                <div className="text-center">
                                    <img className="card-img-top " style={{ width: '100%' }} src={'https://api.cloudinary.com/v1_1/spm2021/image/upload//v1629040165/' + TeamDetails.image} alt="Card image cap" />
                                </div>
                                ...
                                <div className="card-footer bg-white border-0 text-end">
                                    <button type="button" onClick={() => deleteTeamDetails(TeamDetails._id)} className="btn btn-danger btn-sm">Delete <i class="bi bi-trash"></i></button>{' '}
                                    <button type="button" onClick={() => updateTeamDetails(TeamDetails._id, TeamDetails.name, TeamDetails.image, TeamDetails.position)} class="btn btn-success btn-sm">Update <i class="bi bi-pencil-square"></i></button>
                                </div>
                            </div>
                        </div>
                    ))}
